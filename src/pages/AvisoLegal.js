...
import styles from "../styles/modules/AvisoLegal.module.css";
    ...
    <main className="editorial-legal-page">
      <div className="editorial-legal-card">
        ...
        <p>
          ...
          reflejan los siguientes datos del titular de este sitio web:
        </p>
        <ul>
          <li>
            <strong>Titular de la web:</strong> TSINGHE Cocina Fusión, S.L.
            (Entidad simulada para fines académicos).
          </li>
          <li>
            <strong>NIF/CIF:</strong> B-00000000
          </li>
          <li>
            <strong>Domicilio comercial:</strong> Zona Vicálvaro, 28032, Madrid,
            España.
          </li>
          <li>
        ...
        <p>
          ...
          <br />
          El acceso y/o uso de este portal de TSINGHE Cocina Fusión atribuye la
          condición de USUARIO, que acepta, desde dicho acceso y/o uso, las
          Condiciones Generales de Uso aquí reflejadas. Las citadas Condiciones
          serán de aplicación independientemente de las Condiciones Generales de
          Contratación que en su caso resulten de obligado cumplimiento.
        </p>

        <p>
          <strong>3. USO DEL PORTAL</strong>
          <br />
          La página web proporciona el acceso a informaciones, servicios,
          programas o datos (en adelante, "los contenidos") en Internet
          pertenecientes a TSINGHE Cocina Fusión o a sus licenciantes a los que
          el USUARIO pueda tener acceso. El USUARIO asume la responsabilidad del
          uso del portal. Dicha responsabilidad se extiende al registro o
          formulario de datos que fuese necesario para acceder a determinados
          servicios, como el sistema de gestión de reservas de mesas.
        </p>
        <p>
          En dicho registro el USUARIO será responsable de aportar información
          veraz y lícita. El USUARIO se compromete a hacer un uso adecuado de
          los contenidos y servicios que TSINGHE Cocina Fusión ofrece a través
        ...
        <ol>
          ...
          <li>
            Provocar daños en los sistemas físicos y lógicos de TSINGHE Cocina
            Fusión, de sus proveedores o de terceras personas, introducir o
            difundir en la red virus informáticos o cualesquiera otros sistemas
        ...
        <p>
          ...
          <br />
          TSINGHE Cocina Fusión cumple con las directrices del Reglamento
          General de Protección de Datos (RGPD) de la Unión Europea y la Ley
          Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales
          y garantía de los derechos digitales, velando por garantizar un
          correcto uso y tratamiento de los datos personales del usuario
          recopilados en el formulario de reservas.
        </p>

        <p>
          <strong>5. PROPIEDAD INTELECTUAL E INDUSTRIAL</strong>
          <br />
          TSINGHE Cocina Fusión por sí o como cesionaria, es titular de todos
          ...
          enunciativo, imágenes, marcas, logotipos, estructura, diseño y código
          fuente).
        </p>
        <p>
          ...
          cualquier medio técnico, sin la autorización de TSINGHE Cocina Fusión.
        </p>

        <p>
          <strong>6. EXCLUSIÓN DE GARANTÍAS Y RESPONSABILIDAD</strong>
          <br />
          TSINGHE Cocina Fusión no se hace responsable, en ningún caso, de los
        ...
        <div className={styles.academicNotice}>
          <strong>Aviso Académico:</strong> Debido a la naturaleza de este sitio
          web como Entorno de Simulación de un Trabajo Fin de Grado (TFC), se
          informa que este espacio no presta servicios comerciales ni reales de
          restauración, siendo su funcionalidad estrictamente evaluativa y
          didáctica.
        </div>
        ...
        <p>
          ...
          <br />
          TSINGHE Cocina Fusión se reserva el derecho de efectuar sin previo
        ...
        <p>
          <strong>8. ENLACES</strong>
          <br />
          En el caso de que en la página web se dispusiesen enlaces o
          hipervínculos hacía otros sitios de Internet, TSINGHE Cocina Fusión no
          ejercerá ningún tipo de control sobre dichos sitios y contenidos. En
          ningún caso asumirá responsabilidad alguna por los contenidos de algún
          enlace perteneciente a un sitio web ajeno.
        </p>

        <p>
          <strong>9. DERECHO DE EXCLUSIÓN</strong>
          <br />
          TSINGHE Cocina Fusión se reserva el derecho a denegar o retirar el
          acceso a portal y/o los servicios ofrecidos sin necesidad de preaviso,
          a instancia propia o de un tercero, a aquellos usuarios que incumplan
          las presentes Condiciones Generales de Uso.
        </p>

        <p>
          <strong>10. GENERALIDADES</strong>
          <br />
          TSINGHE Cocina Fusión perseguirá el incumplimiento de las presentes
        ...
        <p>
          ...
          <br />
          TSINGHE Cocina Fusión podrá modificar en cualquier momento las
        ...
        <p>
          ...
          <br />
          La relación entre TSINGHE Cocina Fusión y el USUARIO se regirá por la
