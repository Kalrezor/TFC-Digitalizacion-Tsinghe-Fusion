/*
 * Archivo: src/services/ChatbotContextService.js
 * Proposito: Construye contexto del restaurante para el chatbot usando carta, reservas, mesas, horarios y datos de Firestore.
